...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>SEND U R MESSAGE HERE 👉👉   ----> [ @Priyanka_samrottbot ] / GROUP HERE 👉👉 @moviescrown !</b>")
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("❤️ H̳O̳W̳ ̳T̳O̳ ̳̳D̳O̳W̳N̳L̳O̳A̳D̳ ❤️", url=f"https://t.me/how_to_download_movie_from_bot")
    ])
    try:
